...
const Footer = () => {
  return (
    ...
    <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        <div className="md:max-w-96">
            ...
            <p className="mt-6 text-sm" >
               Experience The Power Of AI With Qucik-Ai. <br />Transform your content creation with our suit of premium AI tools. Write articles, generate images and enhance your workflow.
            </p>
        </div>
    ...
    <p className="pt-4 text-center text-xs md:text-sm pb-5">
        Copyright 2025 © Abhay0103. All Right Reserved.
    </p>
</footer>
  )
}
